# YSTYLE TLV — Hebrew Social Ads (Instagram / TikTok)

AI-generated ad creatives for YStyle TLV (women's fashion, Tel Aviv) produced with
Higgsfield, using the brand's real product photos as references. Format: vertical
9:16 for Reels / TikTok / Stories.

## Products & source references

Source photos are in [`ads/source/`](./source). They were imported into Higgsfield
to anchor each creative to the real garment.

| # | Product | Source file |
|---|---------|-------------|
| 1 | White crystal-trim two-piece set (oversized crop top + scalloped rhinestone-trim shorts) | `white_crystal_set.jpg`, `white_crystal_set_closeup.jpg` |
| 2 | Light-wash balloon / barrel jeans (model 5021) | `balloon_jeans_5021.jpg` |
| 3 | Beige checkered asymmetric mini slip dress | `plaid_mini_dress.jpg` |

## Still ads (nano_banana_pro, 9:16, 2K)
...
- https://d8j0ntlcm91z4.cloudfront.net/user_3F1O6weMRqXr9LfttZOeEzhHpcP/hf_20260615_112951_b2171810-36d3-43a8-9b82-bc3274cd52d9.png

**3. Plaid mini dress** — headline "שמלת הקיץ המושלמת" / "YSTYLE TLV"
...
- Result URLs are public Higgsfield CDN links.
- Hebrew on-image text is AI-rendered and should be proofread; regenerate cheaply
  (~2 credits/image) or produce text-free versions and caption in an editor if needed.
